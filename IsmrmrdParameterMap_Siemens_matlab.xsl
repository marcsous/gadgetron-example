            ...
            <encoding>
                ...
                <encodingLimits>
                    ...
                    <segment>
                        ...
                        <maximum>
                            <xsl:choose>
                                <xsl:when test="siemens/MEAS/sFastImaging/lTurboFactor">
                                    <xsl:value-of select="siemens/MEAS/sFastImaging/lTurboFactor - 1"/>
                                </xsl:when>
                                <xsl:otherwise>0</xsl:otherwise>
                            </xsl:choose>
                        </maximum>
        ...
        <parallelImaging>
          ...
          <xsl:if test="(siemens/MEAS/sPat/ucRefScanMode = 1) or (siemens/MEAS/sPat/ucRefScanMode = 16) or (siemens/MEAS/sPat/ucRefScanMode = 32) or (siemens/MEAS/sPat/ucRefScanMode = 64)">
            ...
            <userParameters>
				...
				<!-- MB Stan's loop versions - nice - note unit offset! -->
                ...
                <xsl:for-each select="siemens/MEAS/sWipMemBlock/adFree">
                 ...
                 <!-- MB put other long parameters here
                <userParameterLong>
                    <name>ReconstructionMode</name>
                    <value>
                        <xsl:value-of select="siemens/MEAS/ucReconstructionMode" />
                    </value>
                </userParameterLong>
				-->

 		 		<!-- MB put any string parameters here -->
                 <userParameterString>
